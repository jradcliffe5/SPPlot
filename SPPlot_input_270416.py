#########################################
### SPPlot input file ### Version: 270416
#########################################
#################### Author: Jack Morford
#########################################
...
outfilename = 'choosesource11'      	    # This is the base name of your output plots.


stokes = ['RR', 'LL', 'RL', 'LR']		                  # Must be strings seperated by commas!
...
timeperpage = 4000		                    # Set the amount of visibilities to use per page - i.e. the amount of time 
...
makecombinedplot = 'yes'                  # If 'yes' SPPlot will make thumbnail like .png files of each page and plot them all onto one single page!

onlyplotcombined = 'no'                   # If 'yes' SPPlot will bypass the rest of the makespecplot function to only create the combined plot
                                          # this will speed things up! NB: if 'no' and makecombined plot = 'no' - nothing will be plotted.
