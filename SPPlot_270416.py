...
### This script 'should' not need altering, simply edit the input file named: SPPlot_input_{version}.py

### The core plotting routines have been adapted from PLOT_LIB routines written by Hans-Rainer Klockner.

### Updates:
# Oct 2014 - Original (JM)
# Feb 2015 - Major upgrades, parallelised for machines with multiple CPUs using pythons multiprocessing module (JM)
# Apr 2016 - Addition of combined plots (thanks go Javier Moldon for this idea and piece of code), option to plot
...
try:
    execfile("SPPlot_input_270416.py")
