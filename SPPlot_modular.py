...
#########################################
### Functions ###########################
def SPPlot(Name, Klass, Disk, Seq, path2folder, picklepath, IF, IF_start, IF_end, choosesources, amporphas, outfilename, stokes, timeperpage, yaxisticks, timerange, scale_over_all_IFs, scale, colourscheme, choosebaselines, makecombinedplot, onlyplotcombined, outputsingle_pngs, pngbbox_inches, do_loadflag, flag_tables,specifysources,ticksperpage,baselines):
